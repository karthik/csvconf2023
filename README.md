...
- The calls to action are:
	...
	- Lastly, folks operating at the level of an ecosystem (funders, foundations, trainers, infrastructure providers) can also pick and address several of these issues at scale. 
